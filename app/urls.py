...
urlpatterns = patterns(
    ...
    url(r'^(?P<pk>\d+)/(?P<parent_url>\w+)/$', views.TransactionDetail.as_view(), name='detail'),
    url(r'^(?P<pk>\d+)/(?P<parent_url>\w+)/$', views.TransactionDetailComplete.as_view(), name='detail_complete'),
