...
urlpatterns = patterns(
    ...
    url(r'^(?P<pk>\d+)/(?P<parent_url>\w+)/assign_tasks/$', views.assign_tasks, name="assign_tasks"),
    url(r'^(?P<pk>\d+)/(?P<parent_url>\w+)/assign_parts/$', views.assign_parts, name="assign_parts"),
